...
export function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-60 bg-zinc-900 border-r border-zinc-800 flex flex-col z-30">
      <div className="px-6 py-5 border-b border-zinc-800">
        <span className="text-lg font-bold text-zinc-100 tracking-tight">Whyme</span>
      </div>
