...
class JobOut(BaseModel):
    ...
    education_course_required: Optional[str] = None
    education_course_is_flexible: Optional[bool] = True
    hard_skills_min_match: Optional[int] = None
    postal_code: Optional[str] = None
    acceptance_radius_km: Optional[float] = None
...
class JobUpdate(BaseModel):
    ...
    education_level_min: Optional[str] = None
    education_course_required: Optional[str] = None
    education_course_is_flexible: Optional[bool] = None
    hard_skills_min_match: Optional[int] = None
    postal_code: Optional[str] = None
    acceptance_radius_km: Optional[float] = None
    experience_years_min: Optional[int] = None
...
def _job_to_out(j: Job) -> JobOut:
    return JobOut(
        ...
        education_course_required=j.education_course_required,
        education_course_is_flexible=j.education_course_is_flexible,
        hard_skills_min_match=j.hard_skills_min_match,
        postal_code=j.postal_code,
        acceptance_radius_km=j.acceptance_radius_km,
